...
.NET global tool that converts legacy (VS2015-era) MSBuild project files to the SDK-style format
introduced with Visual Studio 2017. Part of
[CsprojToVs2017](https://github.com/hvanbakel/CsprojToVs2017).

**Install this only if you need to stay on VS2017 conventions.** For current work use
`Net4x.Project2015To2017.Migrate2019.Tool`, which provides `dotnet migrate-2019` and picks proper
project SDKs for desktop and mobile projects.

## Installation

```
dotnet tool install --global Net4x.Project2015To2017.Migrate2017.Tool
```

Requires the .NET 6 runtime. The tool is invoked as `dotnet migrate-2017`.
...
dotnet migrate-2017 wizard .\MyProjectDirectory
...
Not every option applies to every command — check `dotnet migrate-2017 <command> --help`.
...
* `Net4x.Project2015To2017.Migrate2019.Tool` — `dotnet migrate-2019`, the recommended tool
* `Net4x.Project2015To2017.Migrate2017.Library` — the VS2017 transformation and diagnostic sets
